...
//  SpreadsheetApp.getActiveSpreadsheet().insertSheet('Formula'); //inserts the Formula sheet
  ...
  var rule = SpreadsheetApp.newDataValidation().requireValueInList(['Salisbury School', 'San Domenico School','Santa Catalina School','Ross School','Portsmouth Abbey School','South Kent School','Squaw Valley Academy'], true).build();
